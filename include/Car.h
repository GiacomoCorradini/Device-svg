 ...
 * @return puntatore a struct device
*/
coca_device* coca_init_device();

/**
 * funzione errore
 * @param err numero di errore
*/
void coca_error(int err);

/**
 * funzioni check
 * @param device puntarore a struct device
 * @return int per verificare la correttezza dei parametri
*/
 ...
 * @param indev puntarore a struct device
 * @return puntarore a struct device
*/
 ...
 * @param macch puntarore a struct device
 * @return stringa intestazione file svg
*/
 ...
 * Funzione che scrive le stringhe device
 * @param macch puntarore a struct device
 * @param scelta se inserire la intestazione o no del file svg
 * @param quota scelta se inserire o no la quotatura
 * @return stringa per file svg
*/
 ...
 * @param puntarore a struct device
 * @return stringa per file svg
*/
 ...
 * @param svg stringa svg da scrivere su file
 * @return int che indica la buona riuscita della scrittura su file
*/
 ...
 * Funzione che scrive su file
 * @param svg stringa svg da scrivere su file
 * @return macch puntarore a struct device
*/
